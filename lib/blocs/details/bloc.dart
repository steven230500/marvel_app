...
class DetailsBloc extends Bloc<DetailsEvent, DetailsState> {
  ...
  void _onGetComics(
    ...
    final result =
        await _heroRepository.fetchCharacterComics(event.idCharacter);
    result.fold(
      (apiError) {
        emit(
  ...
  void _onGetEvents(
    ...
    final result =
        await _heroRepository.fetchCharacterEvents(event.idCharacter);
    result.fold(
      (apiError) {
        emit(
          DetailsError(state.model),
  ...
  void _onGetStories(
    ...
    final result =
        await _heroRepository.fetchCharacterStories(event.idCharacter);
    result.fold(
      (apiError) {
        emit(
          DetailsError(state.model),
  ...
  void _onGetSeries(
    ...
    final result =
        await _heroRepository.fetchCharacterSeries(event.idCharacter);
    result.fold(
      (apiError) {
        emit(
          DetailsError(state.model),
